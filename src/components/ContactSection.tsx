...
export default function ContactSection() {
		...
		},
		{
			...
			icon: (
				<svg
					...
					xmlns="http://www.w3.org/2000/svg">
					<path
						d="M10.9923 13.8183H5L15.957 2L13.0077 10.1817H19L8.04304 22L10.9923 13.8183Z"
						fill="black"
					/>
				</svg>
			),
	...
	return (
		<section id="contact" className="bg-base-100 py-28">
				...
				<div className="mx-auto max-w-4xl">
					...
					<div className="grid grid-cols-1 gap-6 md:grid-cols-2">
						...
						<ContactInfoCard
							...
							title={t('contactInfo.localisation')}
							value={t('contactDetails.location')}
						/>
						{/* </div>
						</div> */}
					</div>
					...
					<div className="mt-12 flex justify-center space-x-4 xl:hidden">
						{socialLinks.map((link) => (
							<a
								...
								className="bg-primary text-primary-content hover:bg-primary-focus flex h-12 w-12 items-center justify-center rounded-full transition-all duration-300 hover:scale-110"
